...
@section('title', "Farmers' and FisherFolk's Registration System | Login")
         ...
         <div class="login login-with-news-feed">
             ...
             <div class="right-content">
                 ...
                 <div class="login-header">
                     <div class="brand">
                        <img src="{{url('assets/img/images/DA-LOGO-1024x1024.png')}}" width="70" height="70" style="display: inline-block"  /> <b>Farmers' and FisherFolk's Registration System</b>
                     </div>
                     <div class="icon">
